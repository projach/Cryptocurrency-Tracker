...
class RecyclerViewAdapter(private val arrayData: Array<JsonView>,private val arrayID: List<Int>,private val fragment: Fragment) : RecyclerView.Adapter<RecyclerViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerViewHolder, position: Int) {
        holder.bind(arrayData[position], arrayID[position], fragment)
    }
}